      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Navbar va mega menu uchun elementlarni boshqaring. Ota menyu qo'shsangiz, uning pastida mega menu ko'rinadi.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Agar ota menyu bo'lsa, URL ni bo'sh qoldiring
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Asosiy menyu (ota menyu yo'q)" />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <p className="text-xs text-muted-foreground">
                  Ota menyuni tanlasangiz, bu element mega menuda ko'rinadi
                </p>
              </div>
